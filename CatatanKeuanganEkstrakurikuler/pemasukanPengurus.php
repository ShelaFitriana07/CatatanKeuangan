...
?>
        ...
        <body>
            <div class="home">
                ...
                <div class="menu">
                    <a href="pengeluaranPengurus.php">Pengeluaran</a>
                    <a href="pemasukanPengurus.php" class="active">Pemasukan</a>
                </div>
                <?php
                ...
                ?>
                    ...
                    ?>
                            <div class="container-result">
                                ...
                                <div class="delete">
                                    <?php
                                    echo "<a href='delete.php?id_pemasukan={$row['id_pemasukan']}'>";
                        ...
                        ?>
                        <div class="kosong">
                            <b>Ups, belum ada pemasukan.</b>
                            <br>
                            <b>Yuk catat pemasukan kamu!</b>
                        </div>
                    <?php
                    }
                    ?>
            ...
            <div class="tambah">
                <a href="inputPemasukan.php"><img src="Asset/Tambah.png"></a>
            </div>
            <div class="hapus-semua">
                <a href="deletePemasukan.php">HAPUS SEMUA</a>
            </div>
        </body>
